...
const GRUPOS = {
  ...
  I: ["França", "Senegal", "Bolívia/Iraque", "Noruega"], J: ["Argentina", "Argélia", "Áustria", "Jordânia"],
...
function TabJogos({ matches, onChange, isAdmin }) {
  ...
  const gerarCopaFaseDeGrupos = () => {
    ...
    const SCHEDULE_OFICIAL = [
      ...
      { teamA: "França", teamB: "Senegal", date: "16/06 (Ter) - 16:00" }, { teamA: "Bolívia/Iraque", teamB: "Noruega", date: "16/06 (Ter) - 19:00" }, { teamA: "Argentina", teamB: "Argélia", date: "16/06 (Ter) - 22:00" },
      ...
      { teamA: "Argentina", teamB: "Áustria", date: "22/06 (Seg) - 14:00" }, { teamA: "França", teamB: "Bolívia/Iraque", date: "22/06 (Seg) - 18:00" }, { teamA: "Noruega", teamB: "Senegal", date: "22/06 (Seg) - 21:00" },
      ...
      { teamA: "Noruega", teamB: "França", date: "26/06 (Sex) - 16:00" }, { teamA: "Senegal", teamB: "Bolívia/Iraque", date: "26/06 (Sex) - 16:00" }, { teamA: "Uruguai", teamB: "Espanha", date: "26/06 (Sex) - 21:00" }, { teamA: "Cabo Verde", teamB: "Arábia Saudita", date: "26/06 (Sex) - 21:00" },
